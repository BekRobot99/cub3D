...
/*   Updated: 2024/10/27 18:14:51 by abekri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/cub3d.h"

int	init_game_textures(t_graphics *graf) // unused function
{
...
void	set_player_direction(t_graphics *graf)//combine set_player_position_and_fov and set_player_direction
{
	char	dir;
...
int	init_game_loop(t_graphics *graf) // rebuild init_game_loop
{
