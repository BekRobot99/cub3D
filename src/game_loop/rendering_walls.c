...
void	draw_wall(t_graphics *quanta_field, int x,
		int draw_start, double draw_end)
{
	double			x_o;
	double			y_o;
...
void	display_ray(t_graphics *graphics, int ray_index)
{
	...
	graphics->raycast->ray_length
		*= cos(quantum_phase_shift(graphics->raycast->beam_angle
